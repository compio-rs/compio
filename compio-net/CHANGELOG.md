...
## [0.12.1](https://github.com/compio-rs/compio/compare/compio-net-v0.12.0...compio-net-v0.12.1) - 2026-06-01

### Other

- updated the following local packages: compio-driver, compio-runtime
...
- relax bounds on ReadHalf and WriteHalf ([#917](https://github.com/compio-rs/compio/pull/917))

### Fixed

- *(net)* ignore less errors in shutdown ([#910](https://github.com/compio-rs/compio/pull/910))

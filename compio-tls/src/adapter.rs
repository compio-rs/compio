    ...
    pub async fn connect<S: AsyncRead + AsyncWrite + 'static>(
        ...
        match &self.0 {
            ...
            TlsConnectorInner::PyDynamicOpenSsl(c) => {
                handshake_py_dynamic_openssl(c.connect(domain, SyncStream::new(stream))).await
            }
            #[cfg(not(any(feature = "native-tls", feature = "rustls")))]
    ...
    pub async fn accept<S: AsyncRead + AsyncWrite + 'static>(
        ...
        match &self.0 {
            ...
            TlsAcceptorInner::PyDynamicOpenSsl(a) => {
                handshake_py_dynamic_openssl(a.accept(SyncStream::new(stream))).await
            }
            #[cfg(not(any(feature = "native-tls", feature = "rustls")))]
...
#[cfg(feature = "py-dynamic-openssl")]
async fn handshake_py_dynamic_openssl<S: AsyncRead + AsyncWrite>(
    mut res: Result<

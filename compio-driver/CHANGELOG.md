...
## [0.12.5](https://github.com/compio-rs/compio/compare/compio-driver-v0.12.4...compio-driver-v0.12.5) - 2026-07-23
...
- drop linux_5_11 requirement ([#947](https://github.com/compio-rs/compio/pull/947))

## 0.12.2 - 2026-06-05

### Fixed

- close ring instance before dropping in_flight data ([#943](https://github.com/compio-rs/compio/pull/943))

## 0.12.1 - 2026-06-01

### Fixed

- *(driver,iour)* set correct poll_first flag ([#939](https://github.com/compio-rs/compio/pull/939))

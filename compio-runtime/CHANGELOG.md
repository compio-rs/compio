...
## [0.12.4](https://github.com/compio-rs/compio/compare/compio-runtime-v0.12.3...compio-runtime-v0.12.4) - 2026-07-23
...
- *(runtime)* correct sched affinity mask on multi cores ([#956](https://github.com/compio-rs/compio/pull/956))

## 0.12.2 - 2026-06-15

### Fixed

- *(runtime)* features of `futures-util` ([#951](https://github.com/compio-rs/compio/pull/951))
...
- use FutureExt if possible ([#923](https://github.com/compio-rs/compio/pull/923))

### Fixed

- *(runtime)* split the runtime to avoid ref cycle ([#911](https://github.com/compio-rs/compio/pull/911))

...
## [0.10.2](https://github.com/compio-rs/compio/compare/compio-io-v0.10.1...compio-io-v0.10.2) - 2026-09-10
...
- *(io)* remove unsafe usage from slice_to_uninit  ([#1040](https://github.com/compio-rs/compio/pull/1040))
...
- *(io)* avoid livelock between flush and shutdown ([#912](https://github.com/compio-rs/compio/pull/912))
